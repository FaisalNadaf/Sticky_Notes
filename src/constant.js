export const cardData = [
  ...
  { title: "Shopping List", note: "Milk, eggs, bread, butter." },
  { title: "Birthday Reminder", note: "John's birthday is on July 12." },
  { title: "Workout Plan", note: "Run 5km, do 30 push-ups, 20 squats." },
  ...
  { title: "Music Playlist", note: "Favorite songs for the road trip." },
